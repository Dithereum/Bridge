...
$('#btnNext').click(async function(){
    ...
    if(network_From=='eth'){
        ...
        if(asset_Name=='usdt' || asset_Name=='usdc' || asset_Name=='dai' || asset_Name=='pax'){          
            ...
            if(asset_Name=='usdc'){
                ...
                if(allowance<tAmount){
                    var result =await usdcContractInstance.methods.approve(ethereumBridgeContract,tokenAmount).send({
                        from: myAccountAddress,
                        to: usdcAddress,
                        gasPrice: web3GasPrice,
                        gasLimit: gasLimit,
            ...
            if(asset_Name=='dai'){
                ...
                if(allowance<tAmount){
                    var result = await daiContractInstance.methods.approve(ethereumBridgeContract,tokenAmount).send({
                        from: myAccountAddress,
                        to: daiAddress,
                        gasPrice: web3GasPrice,
                        gasLimit: gasLimit,
            ...
            if(asset_Name=='pax'){
                ...
                if(allowance<tAmount){
                    var result =await paxContractInstance.methods.approve(ethereumBridgeContract,tokenAmount).send({
                        from: myAccountAddress,
                        to: paxAddress,
                        gasPrice: web3GasPrice,
                        gasLimit: gasLimit,
    ...
    if(network_From=='dith'){
        ...
        if(asset_To=='eth'){
            ...
            if(allowance<tAmount){
                var result =await usdtContractInstance.methods.approve(bridgeContract,approveAmount).send({
                    from: myAccountAddress,
                    to: ethDthAddress,
                    gasPrice: web3GasPrice,
                    gasLimit: gasLimit,
        ...
        if(asset_To=='usdt' || asset_To=='usdc' || asset_To=='dai' || asset_To=='pax'){          
            ...
            if(asset_To=='usdc'){
                ...
                if(allowance<tAmount){
                    var result =await usdcContractInstance.methods.approve(bridgeContract,approveAmount).send({
                        from: myAccountAddress,
                        to: usdcAddress,
                        gasPrice: web3GasPrice,
                        gasLimit: gasLimit,
            ...
            if(asset_To=='dai'){
                ...
                if(allowance<tAmount){
                    var result =await daiContractInstance.methods.approve(bridgeContract,approveAmount).send({
                        from: myAccountAddress,
                        to: daiAddress,
                        gasPrice: web3GasPrice,
                        gasLimit: gasLimit,
            ...
            if(asset_To=='pax'){
                ...
                if(allowance<tAmount){
                    var result =await paxContractInstance.methods.approve(bridgeContract,approveAmount).send({
                        from: myAccountAddress,
                        to: paxAddress,
                        gasPrice: web3GasPrice,
                        gasLimit: gasLimit,
    ...
    if(network_From=='bsc'){
        ...
        if(asset_Name=='busd'){
            ...
            if(allowance<tAmount){
                var result =await busdbscContractInstance.methods.approve(binanceBridgeContract,tokenAmount).send({
                    from: myAccountAddress,
                    to: busdBscAddress,
                    gasPrice: web3GasPrice,
                    gasLimit: gasLimit,
