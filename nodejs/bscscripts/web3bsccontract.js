...
function getEventData(_fromBlock, _toBlock){ // HERE is some random contract i choosen from bscscan
    ...
    if(parseInt(process.env.lastBSCLatestBlockNumber) < parseInt(_fromBlock)){
        ...
        setTimeout(()=>{
            ...
            var filter = { 'to': '0xA07c5b74C9B40447a954e1466938b865b6BBea36'}            
            myinstance.getPastEvents('Transfer', {
                filter,
...
setTimeout(()=>{    
    ...
    process.env.mybsclastBlock=parseInt(process.env.lastBSCLatestBlockNumber)-500;    
